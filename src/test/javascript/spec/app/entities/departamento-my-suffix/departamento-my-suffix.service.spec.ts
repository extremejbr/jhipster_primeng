...
describe('Service Tests', () => {
    ...
    describe('DepartamentoMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DepartamentoMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/departamentos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DepartamentoMySuffix', () => {
